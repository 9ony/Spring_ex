...
<script>
$(function(){
	CKEDITOR.replace('content'); //content를 ckeditor로~
   ...
   <!-- 원본글쓰기mode는 write, 답변글쓰기 mode는 rewrite로 감  -->       
    <table class="table">
      ...
      <tr>
         ...
         <c:out value="${board.originFilename }"/>[<c:out value="${board.filesize }"/> byte]<br>
         <!-- 새로 첨부할 파일 -->
      ...
      <tr>
         <td colspan="2">
            <button type="submit" id="btnWrite" class="btn btn-success">수정</button>
