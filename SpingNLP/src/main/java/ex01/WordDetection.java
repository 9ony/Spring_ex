...
public class WordDetection {
	public static void main(String[] args) {
		//"Let's get this vis-a-vis", he sait, "these boy's marks are really that well?"
		String input = "Let's get this vis-a-vis\", he sait, \"these boy's marks are really that well?";
